      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-gutter items-center z-10 w-full relative">
        <div className="lg:col-span-7 xl:col-span-6 space-y-stack-md relative z-20">
          ...
          <div className="flex flex-wrap gap-stack-sm pt-4">
            <Link href="/join" className="bg-primary text-on-primary px-8 py-4 rounded-xl font-headline-md text-body-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 inline-block text-center shadow-primary/30">
              Join Community
            </Link>
